...
function [Imgtemp,Imgweight] = LR_WNNM_REW(InputImage, Opts)
...
for  i             =             1 : NN
    ...
    lambda              =                    2*sqrt(2)*Opts.c*2./(cc +  0.35);
        
    %tau                 =                    lambda/lr_lambda;
    
    tau1                  =                   lambda*step*Similar_patch/Opts.mu;

    Thre                =                    1./(diag(GR_V)+0.35);
        
     GR_Z               =                    soft(GR_V,diag(tau1.*Thre));
